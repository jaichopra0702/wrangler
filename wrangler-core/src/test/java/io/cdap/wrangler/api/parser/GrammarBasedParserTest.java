 ...
 */
 ...
 public class GrammarBasedParserTest {
   ...
   // ✅ New test for aggregate-stats directive with BYTE_SIZE and TIME_DURATION
   @Test
   public void testAggregateStatsDirectiveParsing() throws Exception {
    String[] recipe = new String[] {
      "#pragma version 2.0;",
      // Total aggregation with output in MB and seconds
     ...
     Assert.assertEquals("aggregate-stats", directives.get(0).getName());
   }
