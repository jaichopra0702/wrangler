 ...
 */
 ...
 /**
  * Unit tests for the ConvertString class, which includes various string manipulation methods.
  */
...
Assert.assertEquals(expectedResult, convertString.removeTrailingAndLeading(input, "\t"));
   ...
   @Test
   public void testRemoveWhiteSpaceWithoutSpace() {
     ConvertString convertString = new ConvertString();
